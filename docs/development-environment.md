...
| `AI_PROVIDER_REQUEST_TIMEOUT` | AI Provider 连接和响应超时 | `90s` |
...
| `AI_MAX_OUTPUT_TOKENS` | 单次 AI 任务允许的最大 completion Token（包含 reasoning Token） | `8192` |
...
AI_PROVIDER_REQUEST_TIMEOUT=90s
