...
public enum ApiErrorDefinition {
    ...
    ACCOUNT_DELETION_GROUP_OWNER(
            HttpStatus.CONFLICT,
            "Transfer ownership or dissolve every group before deleting this account"),
    ...
    AI_CONSENT_REQUIRED(HttpStatus.FORBIDDEN, "Private AI is not enabled for this conversation"),
    ...
    CONTEXT_CHANGED(HttpStatus.CONFLICT, "The authorized AI context changed before the result was saved"),
